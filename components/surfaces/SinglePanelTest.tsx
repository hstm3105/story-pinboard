...
import { Sparkles, RefreshCw, Terminal, AlertCircle, Image as ImageIcon } from 'lucide-react';
...
export const SinglePanelTest: React.FC = () => {
  ...
  const [framing, setFraming] = useState("Tight dramatic close-up, shallow depth of field, focused emotional intensity");
    ...
    <div className="bg-slate border-2 border-crimson/60 rounded-xl p-6 space-y-6 shadow-2xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 space-y-4">
          <div className="bg-charcoal p-6 rounded-xl border-4 border-slate-900 shadow-2xl relative overflow-hidden flex flex-col items-center min-h-[380px] justify-center">
            {panelData ? (
              <div className="relative w-full max-w-lg aspect-[4/3] rounded-lg overflow-hidden border-4 border-slate-950 shadow-2xl bg-black">
                {/* Imagen 3 Illustrated Art Background (Clean, No Baked-In Text) */}
                <img
                ...
                {/* OVERLAY 3: STYLIZED VECTOR SOUND EFFECT */}
              ...
              <div className="text-center space-y-3 p-8">
                <ImageIcon className="w-12 h-12 text-surface-muted mx-auto" />
                <h3 className="font-display text-lg font-bold text-white uppercase">No Benchmark Panel Generated Yet</h3>
                <p className="font-mono text-xs text-surface-muted max-w-md mx-auto">
                  Click <strong className="text-gold">"⚡ Generate Benchmark Panel"</strong> to invoke Imagen 3 with the strict no-text prompt directive and test the SVG vector lettering compositor.
                </p>
              </div>
            )}
